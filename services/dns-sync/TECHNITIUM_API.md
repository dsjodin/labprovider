...
authoritative reference; docs/design/technitium-dns_design.md sec 3 was written from
...
the one-PTR-per-IP rule from docs/design/technitium-dns_design.md sec 6 is enforced
...
## 5. Differences from docs/design/technitium-dns_design.md sec 3
